...
// Re-export types from dedicated types file (avoids circular dep in client bundles)
export type { BuildingIntelligence, SourceTiming } from "./data-fusion-types";
...
// BuildingIntelligence type is in ./data-fusion-types.ts
// Imported locally for use in this file
import type { BuildingIntelligence, SourceTiming as _SourceTiming } from "./data-fusion-types";
