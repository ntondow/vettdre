  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "evictionExplanation", label: "Please explain", type: "textarea", required: true, showIf: { field: "hasBeenEvicted", value: true } },
        { key: "hasFelony", label: "Have you ever been convicted of a felony?", type: "boolean", required: true },
        { key: "felonyExplanation", label: "Please explain", type: "textarea", required: true, showIf: { field: "hasFelony", value: true } },
        { key: "hasBankruptcy", label: "Have you filed for bankruptcy in the last 7 years?", type: "boolean", required: true },
        { key: "bankruptcyExplanation", label: "Please explain", type: "textarea", required: true, showIf: { field: "hasBankruptcy", value: true } },
    ...
    },
    {
      ...
      label: "Pets",
      fields: [
        { key: "hasPets", label: "Do you have any pets?", type: "boolean", required: true },
        { key: "petType", label: "Type of Pet", type: "select", required: true, showIf: { field: "hasPets", value: true } },
        { key: "petBreed", label: "Breed", type: "text", required: true, showIf: { field: "hasPets", value: true } },
        { key: "petWeight", label: "Weight (lbs)", type: "number", required: true, showIf: { field: "hasPets", value: true } },
        { key: "petPhoto", label: "Upload a photo of your pet", type: "file", required: false, showIf: { field: "hasPets", value: true } },
      ],
    },
    {
      ...
      fields: [
        ...
        { key: "emergencyContactEmail", label: "Contact Email", type: "email", required: false },
      ],
    },
  ],
  roleOverrides: {
    guarantor: { skip: ["additional", "pets"], optional: ["address", "emergency_contact"] },
    occupant: { skip: ["employment", "emergency_contact", "pets"], optional: ["address"] },
    co_applicant: {},
  },
};
