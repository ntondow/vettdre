...
const PLAN_FEATURES: Record<UserPlan, string[]> = {
  free: [
    "NYC Market Intelligence & map search",
    `${FREE_DAILY_SEARCH_LIMIT} searches per day`,
    "Property data, owner names & RPIE status",
    "Live listings & market trends",
    "BMS: deal submissions & invoices",
    "CRM, messages & calendar",
  ],
  explorer: [
    "Everything in Free, plus:",
    "NYC, NYS & NJ markets",
    "Unlimited searches",
    "Distress & investment scores",
    "Ownership chain & corporate filings",
    "Renovation & STR estimates",
    "Quick screen & motivation scores",
  ],
  pro: [
    "Everything in Explorer, plus:",
    "Ownership intelligence & LLC piercing",
    "Direct phone numbers & verified emails",
    "Cap rate analysis & expense benchmarks",
    "Deal Modeler, BOV & Investment Summary",
    "Vitality heatmap & street-level intel",
    "Campaigns, sequences & financing",
  ],
  team: [
    "Everything in Pro, plus:",
    "Investor network access",
    "Full BMS: agents, commissions, compliance",
    "Bulk uploads & audit log",
    "Priority support",
  ],
  enterprise: [
